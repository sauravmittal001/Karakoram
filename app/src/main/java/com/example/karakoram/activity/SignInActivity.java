...
public class SignInActivity extends AppCompatActivity {
    ...
    private CustomSpinner userTypeSpinner;
    ...
    private void setViews() {
        userTypeArray = getResources().getStringArray(R.array.user_type);
        CustomSpinnerAdapter adapter = new CustomSpinnerAdapter(this, R.layout.spinner_item, userTypeArray);
